...
{/* Hero Section - Mobile-First Responsive Split Layout */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
      ...
      <div className="text-white text-center lg:text-left">
        <div className="animate-fade-in-up">
          <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-md rounded-full text-xs sm:text-sm font-medium tracking-wide mb-4 sm:mb-6 border border-white/20">
            BUILDING KAMLOOPS FOR 40+ YEARS
          </span>
          
          <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-8 leading-tight tracking-tight">
            <span className="block mb-1 sm:mb-2">EXCEPTIONAL</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">
              CRAFTSMANSHIP
            </span>
          </h1>
          
          <p className="text-base sm:text-lg lg:text-xl mb-8 sm:mb-10 lg:mb-12 text-gray-200 leading-relaxed font-light max-w-2xl mx-auto lg:mx-0">
      ...
      <div className="flex flex-col items-center lg:items-start justify-center space-y-6 sm:space-y-8">
        
        {/* Primary CTA Button */}
        <Link 
          href="/projects"
          className="w-full sm:w-auto group bg-white text-black px-8 sm:px-10 py-3 sm:py-4 rounded-full text-lg sm:text-xl font-semibold transition-all duration-500 hover:bg-amber-400 hover:scale-105 hover:shadow-2xl flex items-center justify-center"
        >
          View Projects
        ...
        {/* Company Stats */}
        <div className="grid grid-cols-2 gap-8 sm:gap-10 lg:gap-12 text-center lg:text-left w-full max-w-xs sm:max-w-sm lg:max-w-none">
          <div>
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-amber-400 mb-1 sm:mb-2">40+</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8 max-w-md mx-auto lg:mx-0">
                ...
                <div className="text-center lg:text-left">
                  <div className="text-3xl font-bold text-amber-500 mb-2">17+</div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="order-1 lg:order-1">
        ...
        <h3 className="text-3xl font-bold mb-6">1470 Capilano Place</h3>
        ...
        <div className="grid grid-cols-3 gap-8 mb-8">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-400 uppercase tracking-wide">Acres</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-amber-400">$2M+</div>
            <div className="text-sm text-gray-400 uppercase tracking-wide">Investment</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-amber-400">2016</div>
            <div className="text-sm text-gray-400 uppercase tracking-wide">Completed</div>
          </div>
        </div>
        
        <Link href="/projects/1470-capilano" className="w-full sm:w-auto inline-block bg-amber-500 hover:bg-amber-400 text-black px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl text-center mb-8 lg:mb-0">
      ...
      <div className="relative order-2 lg:order-2">
        ...
        <div className="absolute -top-6 -right-6 bg-white text-black p-6 rounded-2xl shadow-xl hidden lg:block">
          <div className="text-center">
            <Award className="h-8 w-8 text-amber-500 mx-auto mb-2" />
            <div className="text-lg font-bold">Estate Living</div>
            <div className="text-sm text-gray-600">Resort Amenities</div>
          </div>
        </div>
      </div>
    </div>
